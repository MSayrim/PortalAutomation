...
public class ConfigLoader {
    ...
    private ConfigLoader(){
        String env = System.getProperty("env", String.valueOf(EnvType.DEVTEST));
        switch (EnvType.valueOf(env)) {
            case DEVTEST -> properties = PropertyUtils.propertyLoader("src/test/resources/devtest_config.properties");
